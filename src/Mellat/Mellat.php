...
class Mellat extends PortAbstract implements PortInterface
{
    ...
    {
        $this->mellatDB = DB::table('mellat')->first();
    }
    ...
    {
        if (!$this->callbackUrl)
            $this->callbackUrl = $this->mellatDB->callbackUrl;
    ...
    protected function sendPayRequest()
    {
        ...
        $fields = array(
            'terminalId' => $this->mellatDB->terminalId,
            'userName' => $this->mellatDB->username,
            'userPassword' => $this->mellatDB->password,
